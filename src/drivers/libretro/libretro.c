...
void retro_set_environment(retro_environment_t cb)
{
   ...
   static const struct retro_controller_description pads1[] = {
      { "自动",    RETRO_DEVICE_AUTO },
      { "手柄",    RETRO_DEVICE_GAMEPAD },
      { "光枪",    RETRO_DEVICE_ZAPPER },
      { 0, 0 },
   };
   ...
   static const struct retro_controller_description pads2[] = {
      { "自动",         RETRO_DEVICE_AUTO },
      { "手柄",         RETRO_DEVICE_GAMEPAD },
      { "打砖块控制器", RETRO_DEVICE_ARKANOID },
      { "光枪",         RETRO_DEVICE_ZAPPER },
      { "体感垫A",  RETRO_DEVICE_POWERPADA },
      { "体感垫B",  RETRO_DEVICE_POWERPADB },
      { 0, 0 },
   };
   ...
   static const struct retro_controller_description pads5[] = {
      { "自动",                  RETRO_DEVICE_FC_AUTO },
      { "打砖块控制器",          RETRO_DEVICE_FC_ARKANOID },
      { "(万代) 光枪",   RETRO_DEVICE_FC_SHADOW },
      { "(科乐美) 光枪",   RETRO_DEVICE_FC_HYPERSHOT },
      { "儿童画板",      RETRO_DEVICE_FC_OEKAKIDS },
      { "4分插适配器",         RETRO_DEVICE_FC_4PLAYERS },
      { "跳舞毯A",      RETRO_DEVICE_FC_FTRAINERA },
      { "跳舞毯B",      RETRO_DEVICE_FC_FTRAINERB },
      { 0, 0 },
   };
...
bool retro_load_game(const struct retro_game_info *info)
{
   ...
   struct retro_input_descriptor desc[] = {
      ...
      { 0, RETRO_DEVICE_JOYPAD, 0, RETRO_DEVICE_ID_JOYPAD_R2,     "(街机) 投币" },
      { 0, RETRO_DEVICE_JOYPAD, 0, RETRO_DEVICE_ID_JOYPAD_L,      "(磁碟机) 磁盘换面" },
      { 0, RETRO_DEVICE_JOYPAD, 0, RETRO_DEVICE_ID_JOYPAD_R,      "(磁碟机) 插入/弹出磁盘" },
      { 0, RETRO_DEVICE_JOYPAD, 0, RETRO_DEVICE_ID_JOYPAD_X,      "连发 A" },
      { 0, RETRO_DEVICE_JOYPAD, 0, RETRO_DEVICE_ID_JOYPAD_Y,      "连发 B" },
      { 0, RETRO_DEVICE_JOYPAD, 0, RETRO_DEVICE_ID_JOYPAD_R3,     "连发 A+B" },
      ...
      { 1, RETRO_DEVICE_JOYPAD, 0, RETRO_DEVICE_ID_JOYPAD_R3,     "连发 A+B" },
      ...
      { 2, RETRO_DEVICE_JOYPAD, 0, RETRO_DEVICE_ID_JOYPAD_X,      "连发 A" },
      { 2, RETRO_DEVICE_JOYPAD, 0, RETRO_DEVICE_ID_JOYPAD_Y,      "连发 B" },
      { 2, RETRO_DEVICE_JOYPAD, 0, RETRO_DEVICE_ID_JOYPAD_R3,     "连发 A+B" },
      ...
      { 3, RETRO_DEVICE_JOYPAD, 0, RETRO_DEVICE_ID_JOYPAD_X,      "连发 A" },
      { 3, RETRO_DEVICE_JOYPAD, 0, RETRO_DEVICE_ID_JOYPAD_Y,      "连发 B" },
      { 3, RETRO_DEVICE_JOYPAD, 0, RETRO_DEVICE_ID_JOYPAD_R3,     "连发 A+B" },
   ...
   struct retro_input_descriptor desc_ps[] = { /* ps: palette switching */
      ...
      { 0, RETRO_DEVICE_JOYPAD, 0, RETRO_DEVICE_ID_JOYPAD_SELECT, "选择" },
      { 0, RETRO_DEVICE_JOYPAD, 0, RETRO_DEVICE_ID_JOYPAD_START,  "开始" },
      { 0, RETRO_DEVICE_JOYPAD, 0, RETRO_DEVICE_ID_JOYPAD_L2,     "切换调色板 (+ 左/右键)" },
      { 0, RETRO_DEVICE_JOYPAD, 0, RETRO_DEVICE_ID_JOYPAD_R2,     "(街机) 投币" },
      { 0, RETRO_DEVICE_JOYPAD, 0, RETRO_DEVICE_ID_JOYPAD_L,      "(磁碟机) 磁盘换面" },
      { 0, RETRO_DEVICE_JOYPAD, 0, RETRO_DEVICE_ID_JOYPAD_R,      "(磁碟机) 插入/弹出磁盘" },
      { 0, RETRO_DEVICE_JOYPAD, 0, RETRO_DEVICE_ID_JOYPAD_X,      "连发 A" },
